        ...
        <c:forEach var="member" items="${memberList}">
            <tr>
                ...
                <c:if test="${uId==owner.uId}">
                    <td>
                        <div class="btn-group">
                            <button class="btn btn-default delete_member_btn" member_id="${member.uId}">踢出群组</button>
                        </div>
                    </td>
                </c:if>
            </tr>
    ...
    <table class="table">
        ...
        <c:forEach var="file" items="${groupFileShareList}">
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <button class="btn btn-default download_file_btn" f_id="${file.fileHeader.fId}">下载</button>
                        <c:if test="${file.provider.uId==uId||owner.uId==uId}">
                            <button class="btn btn-default group_shared_file_delete_btn" f_id="${file.fileHeader.fId}">取消分享</button>
                        </c:if>
                    </div>
                </td>
            </tr>
